...
object I2C {
  ...
  case class GetDevice(bus: Int, address: Int, replyTo: ActorRef[Device]) extends Command
...
object I2C_HW {
  ...
  def deviceProvider: Behavior[I2C.Command] = Behaviors.receive { (context, message) =>
    message match {
